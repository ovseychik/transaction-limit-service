...
Дополнительно, было развёрнуто на удаленном сервере. 
Можно обраититься с помощью соответствующей коллекции Postman, см. ниже. 
...
* Метод: `POST`
* Дополнительные параметры стартовой строки: нет
* Тело запроса: должно содержать данные лимите в формате json:
